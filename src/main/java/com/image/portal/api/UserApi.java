...
public interface UserApi {
     ...
     */
    @ApiOperation(value = "Retrieve info about the user's account", nickname = "getUserInfo", notes = "", response =
            User.class, tags = {"STRETCH - account",})
    @ApiResponses(value = {
     ...
     * or Invalid input provided (status code 400)
     */
    @ApiOperation(value = "Add or update info about the account", nickname = "updateUserInfo", notes = "", response =
            User.class, tags = {"STRETCH - account",})
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "successful operation", response = User.class),
            @ApiResponse(code = 400, message = "Invalid input provided")})
